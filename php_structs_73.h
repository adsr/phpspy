...
/* Assumes 8-byte pointers */
                                                    /* offset   length */
struct PHPSPY_PACK _zend_array_73 {
...
struct PHPSPY_PACK _zend_executor_globals_73 {
...
struct PHPSPY_PACK _zend_execute_data_73 {
...
struct PHPSPY_PACK _zend_op_array_73 {
...
union PHPSPY_PACK _zend_function_73 {
    uint8_t                 type;                   /* 0        +1 */
    struct {
        uint8_t             pad0[8];                /* 0        +8 */
...
struct PHPSPY_PACK _zend_class_entry_73 {
    uint8_t                 pad0[8];                /* 0        +8 */
    zend_string_73          *name;                  /* 8        +8 */
};

struct PHPSPY_PACK _zend_string_73 {
    uint8_t                 pad0[16];               /* 0        +16 */
    size_t                  len;                    /* 16       +8 */
    char                    val[1];                 /* 24       +1 */
};

struct PHPSPY_PACK _zend_op_73 {
    uint8_t                 pad0[24];               /* 0        +24 */
    uint32_t                lineno;                 /* 24       +4 */
};

struct PHPSPY_PACK _sapi_request_info_73 {
    uint8_t                 pad0[8];                /* 0        +8 */
...
struct PHPSPY_PACK _sapi_globals_struct_73 {
    uint8_t                 pad0[8];                /* 0        +8 */
...
union PHPSPY_PACK _zend_value_73 {
    long                    lval;                   /* 0        +8 */
    double                  dval;                   /* 0        +8 */
...
struct PHPSPY_PACK _Bucket_73 {
    zval_73                 val;                    /* 0        +16 */
    uint64_t                h;                      /* 16       +8 */
    zend_string_73          *key;                   /* 24       +8 */
};

struct PHPSPY_PACK _zend_alloc_globals_73 {
    zend_mm_heap_73         *mm_heap;               /* 0        +8 */
};

struct PHPSPY_PACK _zend_mm_heap_73 {
    uint8_t                 pad0[16];               /* 0        +16 */
    size_t                  size;                   /* 16       +8 */
    size_t                  peak;                   /* 24       +8 */
};
