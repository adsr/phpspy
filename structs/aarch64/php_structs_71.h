...
typedef struct _zend_object_71           zend_object_71;
typedef struct _pdo_bound_param_data_71  pdo_bound_param_data_71;
typedef struct _pdo_stmt_t_71            pdo_stmt_t_71;
...
struct __attribute__((__packed__)) _zend_object_71 {
    uint8_t                 pad0[16];               /* 0        +16 */
    zend_class_entry_71     *ce;                    /* 16       +8 */
    uint8_t                 pad1[16];               /* 24       +16 */
    zval_71                 properties_table[1];    /* 40       +16 */
};

struct __attribute__((__packed__)) _pdo_bound_param_data_71 {
    zval_71                 parameter;              /* 0        +16 */
    uint8_t                 pad0[16];               /* 16       +16 */
    int64_t                 paramno;                /* 32       +8 */
    zend_string_71          *name;                  /* 40       +8 */
    uint8_t                 pad1[24];               /* 48       +24 */
    int32_t                 param_type;             /* 72       +4 */
};

struct __attribute__((__packed__)) _pdo_stmt_t_71 {
    uint8_t                 pad0[56];               /* 0        +56 */
    zend_array_71           *bound_params;          /* 56       +8 */
    uint8_t                 pad1[264];              /* 64       +264 */
    zend_object_71          std;                    /* 328      +56 */
};
