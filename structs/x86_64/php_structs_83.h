...
typedef struct _zend_object_83           zend_object_83;
typedef struct _pdo_bound_param_data_83  pdo_bound_param_data_83;
typedef struct _pdo_stmt_t_83            pdo_stmt_t_83;

/* Assumes 8-byte pointers */
                                                    /* offset   length */
struct __attribute__((__packed__)) _zend_array_83 {
    uint8_t                 pad0[8];                /* 0        +8 */
    uint8_t                 flags;                  /* 8        +1 */
    uint8_t                 pad1[3];                /* 9        +3 */
...
struct __attribute__((__packed__)) _zend_executor_globals_83 {
...
union __attribute__((__packed__)) _zend_value_83 {
    long                    lval;                   /* 0        +8 */
    double                  dval;                   /* 0        +8 */
...
struct __attribute__((__packed__)) _zval_83 {
...
struct __attribute__((__packed__)) _zend_execute_data_83 {
...
struct __attribute__((__packed__)) _zend_op_array_83 {
...
union __attribute__((__packed__)) _zend_function_83 {
    uint8_t                 type;                   /* 0        +1 */
    struct {
        uint8_t             pad0[8];                /* 0        +8 */
...
struct __attribute__((__packed__)) _zend_class_entry_83 {
    uint8_t                 pad0[8];                /* 0        +8 */
    zend_string_83          *name;                  /* 8        +8 */
};

struct __attribute__((__packed__)) _zend_string_83 {
    uint8_t                 pad0[16];               /* 0        +16 */
    size_t                  len;                    /* 16       +8 */
    char                    val[1];                 /* 24       +1 */
};

struct __attribute__((__packed__)) _zend_op_83 {
    uint8_t                 pad0[24];               /* 0        +24 */
    uint32_t                lineno;                 /* 24       +4 */
};

struct __attribute__((__packed__)) _sapi_request_info_83 {
    uint8_t                 pad0[8];                /* 0        +8 */
...
struct __attribute__((__packed__)) _sapi_globals_struct_83 {
    uint8_t                 pad0[8];                /* 0        +8 */
...
struct __attribute__((__packed__)) _Bucket_83 {
    zval_83                 val;                    /* 0        +16 */
    uint64_t                h;                      /* 16       +8 */
    zend_string_83          *key;                   /* 24       +8 */
};

struct __attribute__((__packed__)) _zend_alloc_globals_83 {
    zend_mm_heap_83         *mm_heap;               /* 0        +8 */
};

struct __attribute__((__packed__)) _zend_mm_heap_83 {
    uint8_t                 pad0[16];               /* 0        +16 */
    size_t                  size;                   /* 16       +8 */
    size_t                  peak;                   /* 24       +8 */
};

struct __attribute__((__packed__)) _zend_object_83 {
    uint8_t                 pad0[16];               /* 0        +16 */
    zend_class_entry_83     *ce;                    /* 16       +8 */
    uint8_t                 pad1[16];               /* 24       +16 */
    zval_83                 properties_table[1];    /* 40       +16 */
};

struct __attribute__((__packed__)) _pdo_bound_param_data_83 {
    zval_83                 parameter;              /* 0        +16 */
    uint8_t                 pad0[16];               /* 16       +16 */
    int64_t                 paramno;                /* 32       +8 */
    zend_string_83          *name;                  /* 40       +8 */
    uint8_t                 pad1[24];               /* 48       +24 */
    int32_t                 param_type;             /* 72       +4 */
};

struct __attribute__((__packed__)) _pdo_stmt_t_83 {
    uint8_t                 pad0[56];               /* 0        +56 */
    zend_array_83           *bound_params;          /* 56       +8 */
    uint8_t                 pad1[248];              /* 64       +248 */
    zend_object_83          std;                    /* 312      +56 */
};
