...
enum {
    PHPSPY_TRACE_EVENT_INIT = 0,
    PHPSPY_TRACE_EVENT_STACK_BEGIN,
    PHPSPY_TRACE_EVENT_FRAME,
    PHPSPY_TRACE_EVENT_VARPEEK,
    PHPSPY_TRACE_EVENT_GLOPEEK,
    PHPSPY_TRACE_EVENT_REQUEST,
    PHPSPY_TRACE_EVENT_MEM,
    PHPSPY_TRACE_EVENT_STACK_END,
    PHPSPY_TRACE_EVENT_ERROR,
    PHPSPY_TRACE_EVENT_DEINIT,
};

enum {
    PHPSPY_ZVAL_TYPE_UNDEF = 0,
    PHPSPY_ZVAL_TYPE_NULL,
    PHPSPY_ZVAL_TYPE_FALSE,
    PHPSPY_ZVAL_TYPE_TRUE,
    PHPSPY_ZVAL_TYPE_LONG,
    PHPSPY_ZVAL_TYPE_DOUBLE,
    PHPSPY_ZVAL_TYPE_STRING,
    PHPSPY_ZVAL_TYPE_ARRAY,
    PHPSPY_ZVAL_TYPE_OBJECT,
    PHPSPY_ZVAL_TYPE_RESOURCE,
    PHPSPY_ZVAL_TYPE_REFERENCE,
};

enum {
    PHPSPY_LONGOPT_ADDR_EXECUTOR_GLOBALS = 256,
    PHPSPY_LONGOPT_ADDR_SAPI_GLOBALS,
